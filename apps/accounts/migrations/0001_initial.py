    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ui_theme', models.CharField(choices=apps.core.constants.ui_theme_choices, default='A', help_text='Selected UI style, set from the Settings screen (SC08_CaiDat).', max_length=1)),
                ('target_bjt_level', models.CharField(choices=apps.core.constants.bjt_level_choices, default='J5', max_length=3)),
                ('daily_review_goal', models.PositiveSmallIntegerField(default=20)),
                ('timezone', models.CharField(default='Asia/Tokyo', help_text="Múi giờ IANA, vd 'Asia/Tokyo' hoặc 'Asia/Ho_Chi_Minh'.", max_length=64)),
                ('daily_reminder_enabled', models.BooleanField(default=True)),
                ('weekly_email_summary_enabled', models.BooleanField(default=False)),
                ('total_points', models.PositiveIntegerField(default=0, help_text='Tổng điểm đóng góp cộng đồng — cache, không sửa tay, xem apps.gamification.services.')),
